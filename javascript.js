var $=function(id){return document.getElementById(id);};var help="<ul> \
 ...
 </ul>";var search=[["","https://www.google.com/#q="],["!g","https://www.google.com/#q="],["!i","https://www.google.com/search?tbm=isch&q="],["!m","http://www.imdb.com/find?q="],["!u","http://www.urbandictionary.com/define.php?term="],["!w","http://en.wikipedia.org/w/index.php?search="],["!y","https://www.youtube.com/results?search_query="],];var menus=[["Daily"],["Entertainment"],["Social"],["Other"],];var showFavicon=true;var links=[["Imgur","https://imgur.com/",""],["","",""],["YouTube","https://www.youtube.com/",""],["Netflix","http://netflix.com",""],["","",""],["Gmail","https://mail.google.com/",""],["Facebook","http://facebook.com",""],["Twitch","http://www.twitch.tv/directory/following",""],["","",""],["Dropbox","https://www.dropbox.com",""],["Pastebin","http://pastebin.com",""],];var ss="";function init(){for(var i=0;i<search.length;i++)
if(search[i][0]=="")
ss=search[i][1];if(ss=="")
